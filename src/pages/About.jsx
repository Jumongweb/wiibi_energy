      ...
      <div className="mt-16">
        ...
        >
          {Array(4).fill().map((_, i) => (
            ...
            >
              <p className="font-bold mb-8">Solar + Lithium Packages</p>
              <div>
                <p className="font-medium text-gray-800">What it delivers</p>
                <p className="text-sm text-gray-600 mt-1">
                  High-efficiency panels paired with long-life Li-ion batteries for maximum uptime.
                </p>
              </div>
              <div className="mt-8">
                <p className="font-medium text-gray-800">Typical Clients</p>
                <p className="text-sm text-gray-600 mt-1">Homes, SMEs, tech hubs</p>
              </div>
            </div>
          ))}
        </div>
