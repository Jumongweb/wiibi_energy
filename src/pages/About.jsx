...
const packages = [
  {
    ...
    delivers: "Max uptime. High-efficiency",
    delivers2: "panels + durable lithium ",
    delivers3: "batteries",
    clients: "Homes, tech hubs, SMEs.",
  },
  {
    title: "Tubular Battery Backup",
    delivers: "Reliable hybrid backup with ",
    delivers2: "mobile monitoring.",
    delivers3: "",
    clients: "Clinics, schools retial shops.",
  },
  {
    title: "Smart Inverter Retrofits",
    delivers: "Upgrade your old system with app-based",
    delivers2: "smart controls",
    delivers3: "",
    clients: "SMEs, homes.",
  },
  {
    title: "IoT Energy Monitoring",
    delivers: "Get visibility and control. Ideal",
    delivers2: "for smart homes and ",
    delivers3: "devepers.",
    clients: "Smart-home enthusiasts, property developers",
  },
  {
    title: "Consulting & Financing",
    delivers: "We provide site audits, ROI",
    delivers2: "modeling, and flexible plans ",
    delivers3: "for new builds.",
